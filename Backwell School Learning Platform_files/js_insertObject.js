// ***** Copyright ©2007 Frogtrade Limited. All rights reserved *****
//
// Purpose: Insert a flash object via external javascript to get around the 'click to activate' IE thing.
//
// Notes: 
//

function insertFlash(movieurl, width, height, quality, bgcolor, id) {
...
function insertFlashProperly(movieurl, width, height, quality, bgcolor, id, insertPoint, flashvars, allowfullscreen)
{
	var insert_point = $('#' + insertPoint);

	if(width == -1) width = 600;
	if(height == -1) height = 450;
	if(!id) id = insertPoint + '_flash';
